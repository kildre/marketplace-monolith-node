...
export class UseCaseRequest
  extends Model<InferAttributes<UseCaseRequest>, InferCreationAttributes<UseCaseRequest>> {
    ...
    UseCaseRequest.init(
      {
        ...
        requestNumber: { type: DataTypes.STRING(32), allowNull: false, unique: true, field: 'request_number' },
        ...
        pointOfContact: { type: DataTypes.STRING(128), allowNull: true, field: 'point_of_contact' },
        requestedToolName: { type: DataTypes.STRING(128), allowNull: false, field: 'requested_tool_name' },
        phoneNumber: { type: DataTypes.STRING(32), allowNull: true, field: 'phone_number' },
        estimatedRom: { type: DataTypes.STRING(32), allowNull: true, field: 'estimated_rom' },
  ...
  static associate(sequelize: Sequelize) {
    const { MarketplaceUser, Status, Decision, CartItem } = sequelize.models as any;
